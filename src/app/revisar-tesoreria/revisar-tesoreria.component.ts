...
@Component({
  selector: 'app-revisar-tesoreria',
  templateUrl: './revisar-tesoreria.component.html',
  styleUrls: ['./revisar-tesoreria.component.scss']
})
export class RevisarTesoreriaComponent implements OnInit {
    ...
    dialogRef$.afterClosed().subscribe(result =>{
      ...
      else
      {
        ...
        console.log('Se va a rechazar la partida con el id: ' + id);
          ...
          const motivoRechazo$ = this._catalogoService.rechazarTesoreria(
            id,
            motivo,
  ...
  guardar(id:number){
    const guardarAprobado$ = this._catalogoService.aprobarTesoreria(
      id,
